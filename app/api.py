...
def update_post():
    ...
    Returns:
        ...
        error: null if successful, str with error message otherwise.
...
def version_get():
    ...
    Returns:
        ...
        success: true if successful, false otherwise.
        error: null if successful, str with error message otherwise.
        version: str containing the current installed version of TinyPilot.
...
def latest_release_get():
    ...
    Returns:
        ...
        success: true if successful, false otherwise.
        error: null if successful, str with error message otherwise.
        version: str containing the latest version of TinyPilot.
