...
KEYCODE_MINUS = 0x38  #0x2d NO_-   -_
KEYCODE_EQUAL_SIGN = 0x2d  #0x2e NO_+   +?
KEYCODE_LEFT_BRACKET = 0x2e  #0x2f NO_\   \`´
KEYCODE_RIGHT_BRACKET = 0x2f  #0x30 NO_Å
KEYCODE_BACKSLASH = 0x35  #0x31 NO_|   |§
KEYCODE_HASH = 0x32
KEYCODE_SEMICOLON = 0x30  #0x33 NO_¨   ¨^~
KEYCODE_SINGLE_QUOTE = 0x34  #0x34 NO_Æ
KEYCODE_ACCENT_GRAVE = 0x33  #0x35 NO_Ø
KEYCODE_COMMA = 0x36
KEYCODE_PERIOD = 0x37
KEYCODE_FORWARD_SLASH = 0x32  #0x38 NO_'   '*
...
KEYCODE_RIGHT_PARENTHESIS = 0x0
KEYCODE_U_ACCENT = 0x0
